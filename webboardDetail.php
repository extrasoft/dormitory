...
if(isset($_GET['logout'])){
  ...
  $queryTopic = "SELECT * FROM topic JOIN member ON topic.mem_id = member.mem_id WHERE topic.dorm_id = '$_SESSION[dormitory]' AND topic.topic_id = '$id'";
  ...
  $queryReply = "SELECT * FROM reply JOIN member ON reply.mem_id = member.mem_id
                 WHERE reply.dorm_id = '$_SESSION[dormitory]'
      ...
      <div class="container-fluid">
        ...
        <div class="panel panel-primary">
          ...
          <div class="panel-body" style="font-size:12px;">
              ...
              ?>
              <p align="center"><img src="images/img-topic/<?php echo $topicIMG[$i];?>" class="img-responsive" alt="Responsive image"></p>
              <?php }} ?>
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body" >
              ...
              for ($i=0; $i < $countReply; $i++) {
                ?>
              <p align="center"><img src="images/img-reply/<?php echo $replyIMG[$i];?>" class="img-responsive" alt="Responsive image"></p>
              <?php }} ?>
