...
<head>
  ...
  <title>เลือกการคิดบริการค่าไฟ</title>
  ...
  <div id="wrapper">
    ...
    <div id="page-content-wrapper" style="font-size:16px;">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="text-center">เลือกการคิดบริการค่าไฟ</h3><hr>
          </div>
        </div>
        <center>
        ...
        <form name="formTariffsAdd" action="electricTariffsQuery.php" enctype="multipart/form-data" method="post">
        <?php
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" class="form-control" id="inputMonth" name="name" name="name" min="1.0" step="0.1" placeholder="ยกตัวอย่าง เช่น ราคาเดือนละ 100 บาท" required>
