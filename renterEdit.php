...
<div class="panel panel-primary">
  <div class="panel-heading">
    <div class="panel-title" style="font-size:20px;">
      <strong>แก้ไขข้อมูลผู้เช่า</strong>
      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
    </div>
  </div>
  <div class="panel-body">
    <form class="form-horizontal" name="formAdd" action="renterAddQuery.php" enctype="multipart/form-data"
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <div class="input-group">
              ...
              <input type="text" class="form-control" id="inputFirstname" name="fname" placeholder="ชื่อจริง" value="<?php echo $row['rent_firstname']?>" onKeyPress="return NameCode(fname)">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <div class="input-group">
              ...
              <input type="text" class="form-control" id="inputLastname" name="lname" placeholder="นามสกุล" value="<?php echo $row['rent_lastname']?>" onKeyPress="return NameCode(lname)">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <div class="input-group">
              ...
              <textarea class="form-control" rows="4" id="inputAddress" name="addr" placeholder="ที่อยู่ปัจจุบัน"><?php echo $row['rent_address']?></textarea>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <div class="input-group">
              ...
              <input type="email" class="form-control" id="inputEmail" name="email" placeholder="example@email.com" value="<?php echo $row['rent_email']?>">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-7">
            <div class="input-group">
              ...
              <input type="tel" class="form-control" id="InputTel" name="tel"  placeholder="08xxxxxxxx , 09xxxxxxxx"
               maxlength="10" pattern="^0[8-9][0-9]{8}$" onKeyPress="return isPhoneNo(tel)" value="<?php echo $row['rent_tel']?>">
            </div>
          </div>
        </div>
      </div>
