...
$query = "SELECT * FROM water_tariffs WHERE dorm_id = '$_SESSION[dormitory]'";
  ...
  <div id="wrapper">
    ...
    <div id="page-content-wrapper" style="font-size:16px;">
      <div class="container-fluid">
        ...
        <form name="formTariffsAdd" action="waterTariffsEditQuery.php" enctype="multipart/form-data" method="post">
        <?php
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="number" class="form-control" id="inputMonth" name="name" min="1.0" step="0.1" value="<?php if($row[1]==1) echo $row[2]; ?>" placeholder="ยกตัวอย่าง เช่น ราคาเดือนละ 100 บาท" required>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <span class="input-group-addon" style="background-color:#3bafda;border-color:#3bafda;"><i class="glyphicon glyphicon-user"></i></span>
                    <input type="number" class="form-control" id="inputMonth" name="name" min="1.0" step="0.1" value="<?php if($row[1]==2) echo $row[2]; ?>" placeholder="ยกตัวอย่าง เช่น ราคาหัวละ 100 บาท" required>
                    <span class="input-group-addon" style="background-color:#3bafda;border-color:#3bafda;">฿</span>
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <span class="input-group-addon" style="background-color:#3bafda;border-color:#3bafda;"><i class="glyphicon glyphicon-user"></i></span>
                    <input type="number" class="form-control" id="inputMonth" name="name" min="1.0" step="0.1" value="<?php if($row[1]==3) echo $row[2]; ?>" placeholder="ยกตัวอย่าง เช่น ราคาหน่วยละ 5.5 บาท" required>
                    <span class="input-group-addon" style="background-color:#3bafda;border-color:#3bafda;">฿</span>
                  </div>
                </div>
              </div>
