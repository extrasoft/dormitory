...
<body style="margin-top:<?php if(isset($_SESSION['dormSelect'])) echo "135px"; else echo "70px";?>">
  ...
  <div id="MainContent">
    <div class="container">
      ...
      <?php
      if(isset($_POST['month'])) {
        $queryWater = "SELECT * FROM water_alert WHERE awater_month = '$subSum' AND room_id = '$_SESSION[roomSelect]' AND mem_id='$_SESSION[id]'";
            ...
            <div class="col-md-12">
              <?php if($numWater > 0) {?>
                <div class="panel panel-info">
                  <div class="panel-heading">
                    <h4 class="panel-title">
                      <p>เลขมิเตอร์ที่แจ้ง : <?php echo $rowWater['awater_meter'];?></p>
                    </h4>
                  </div>
                  <div class="panel-body" style="font-size:14px;color:grey;">
                    <p align="center">
                      <?php if(!empty($rowWater['awater_img'])) {?>
                      <img src="../images/img-waterAlert/<?php echo $rowWater['awater_img'];?>" class="img-responsive" alt="Responsive image" >
                      <?php } ?>
                    </p>
                  </div>
                </div>
                <a class="btn btn-warning btn-block" data-toggle="modal" data-target="#myModal"
                href="waterAlertEdit.php?id=<?php echo $rowWater['awater_id'];?>&month=<?php echo $subSum;?>">
                ...
                <?php }else{ ?>
                  ...
                  href="waterAlertAdd.php?month=<?php echo $subSum;?>">
