...
<div class="modal-header">
  ...
  <h4 class="modal-title" id="myModalLabel">ตั้งกระทู้สอบถาม</h4>
</div>
<form class="form-horizontal" name="formAdd" action="topicAddQuery.php" enctype="multipart/form-data" method="post"
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="InputTopic" name="topic"  placeholder="กรอกข้อมูลหัวข้อที่จะสอบถาม" required>
      </div>
    </div>
  </div>
