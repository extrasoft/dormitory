...
$id = $_GET['id'];
$queryelectric = "SELECT * FROM electric_alert WHERE aelectric_id = '$id'";
...
<form class="form-horizontal" name="formAdd" action="electricAlertEditQuery.php" enctype="multipart/form-data" method="post">
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="InputTopic" name="meter" value="<?php echo $rowelectric['aelectric_meter'];?>"  placeholder="กรอกข้อมูลเลขมิเตอร์ที่จะแจ้ง" required>
      </div>
    </div>
  </div>
...
<div class="modal-footer">
  ...
  <input type="hidden" name="nameImg" value="<?php echo $rowelectric['aelectric_img']?>">
