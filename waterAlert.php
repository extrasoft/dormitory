...
<head>
  ...
  <title>ผู้เช่าแจ้งมิเตอร์น้ำ</title>
                  ...
                  <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        while($row = mysqli_fetch_array($result)) {
                          $queryWater = "SELECT * FROM water_alert WHERE awater_month = '$subSum' AND room_id = '$row[room_id]'";
                          ...
                          <tr>
                            ...
                            <td class="text-center">
                              <?php if($rowWater['awater_img'] != "") { ?>
                              <a class="btn btn-xs btn-primary" data-toggle="modal" data-target="#myModal" href="waterAlertView.php?id=<?php echo $rowWater['awater_id'];?>">
