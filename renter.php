...
$queryRenter = "SELECT * FROM renter WHERE mem_id = '$_SESSION[id]'";
$resultRenter = mysqli_query($conn,$queryRenter);
$numRenter = mysqli_num_rows($resultRenter);
$num = 1;
?>
<!DOCTYPE html>
<html lang="en">
...
<body style="padding-top: 50px;">
  ...
  <div id="wrapper">
          ...
          <div class="panel-heading">
            ...
            <form class="form-inline" method="post" action="" name="form2">
              <strong style="font-size:16px">
                ...
                <span>
                  <a href="renterAdd.php" class="btn btn-xs btn-warning pull-right" data-toggle="modal" data-target="#myModal">
                    <i class="glyphicon glyphicon-plus"></i> เพิ่มข้อมูลผู้เช่า
                  </a>
                </span>
              </strong>
            </form>
          ...
          <div class="panel-body">
            <div class="table-responsive">
              ...
              <table class="table table-bordered table-striped table-hover datatable">
                ...
                <tbody>
                  <?php  while($row = mysqli_fetch_array($resultRenter)) { ?>
                    <tr>
                      <td class="text-center"><?php echo $num++; ?></td>
                      <td><?php echo $row['rent_firstname']; ?></td>
                      <td><?php echo $row['rent_lastname']; ?></td>
                      <td class="text-center"><?php echo $row['rent_tel']; ?></td>
                      <td class="text-center">
                        <a href="renterEdit.php?id=<?php echo $row['rent_id'];?>" class="btn btn-xs btn-warning" data-toggle="modal" data-target="#myModal">
                          <i class="glyphicon glyphicon-pencil"></i>
                        </a>
                        <a href="renterDelete.php?id=<?php echo $row['rent_id'];?>" class="btn btn-xs btn-danger" data-toggle="modal" data-target="#myModal">
    ...
    function fncSubmit(frm)
    {
      ...
      {
        alert('กรุณากรอก เบอร์โทรศัพท์มือถือ ให้เรียบร้อย');
