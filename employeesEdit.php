...
<div class="panel panel-primary">
  ...
  <div class="panel-body">
    <form class="form-horizontal" name="formEdit" action="employeesEditQuery.php" enctype="multipart/form-data"
    method="post" onSubmit="JavaScript:return fncSubmit('formEdit');">
    <!--Row 1-->
    <div class="row">
      <div class="col-md-6">
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <div class="input-group">
              ...
              <input type="text" class="form-control" id="inputFirstname" name="fname" placeholder="ชื่อจริง" value="<?php echo $row['emp_firstname'];?>" onKeyPress="return NameCode(fname)">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <div class="input-group">
              ...
              <input type="text" class="form-control" id="inputLastname" name="lname" placeholder="นามสกุล" value="<?php echo $row['emp_lastname'];?>" onKeyPress="return NameCode(lname)">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <div class="input-group">
              ...
              <textarea class="form-control" rows="4" id="inputAddress" name="addr" placeholder="ที่อยู่ปัจจุบัน"><?php echo $row['emp_address'];?></textarea>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <div class="input-group">
              ...
              <input type="email" class="form-control" id="inputEmail" name="email" placeholder="example@email.com" value="<?php echo $row['emp_email'];?>">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <div class="input-group">
              ...
              pattern="^0[8-9][0-9]{8}$" onKeyPress="return isPhoneNo(tel)" value="<?php echo $row['emp_tel'];?>">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-king"></i></span>
              <input type="text" class="form-control" id="inputPosition" name="position" placeholder="ตำแหน่ง" value="<?php echo $row['emp_position'];?>" onKeyPress="return NameCode(position)">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <div class="input-group">
              ...
              <input type="number" class="form-control" id="inputSalary" name="salary" min="0" value="<?php echo $row['emp_salary'];?>" placeholder="เงินเดือน">
            </div>
          </div>
        </div>
      </div>
