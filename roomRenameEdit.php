  ...
  <div id="wrapper">
    ...
    <div id="page-content-wrapper">
      <div class="container-fluid">
        ...
        <form name="formEdit" action="roomRenameEditQuery.php" enctype="multipart/form-data" method="post" >
        <div class="row">
          <div class="col-md-12">
            <?php
                ...
                <tbody>
                  ...
                  while($row = mysqli_fetch_row($result)) {
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="text" class="form-control" name="name[]" placeholder="กรอกชื่อห้องที่ต้องการแก้ไข">
          ...
          <div class="row">
            ...
            <div class="col-md-2">
              <button type="submit" name="button" class="btn btn-default btn-lg btn-block" data-toggle="modal" data-target="#modalAdd">
